...
Security
Insights
funky-friday-autoplay/main.lua
@wally-rblx
wally-rblx implement save manager
Latest commit 457c342 13 days ago
 History
 2 contributors
@wally-rblx@greasemonkey123
493 lines (401 sloc)  17.8 KB
...
do
    local window = library:CreateWindow('Funky Friday') do
        local folder = window:AddFolder('Autoplayer') do
            ...
            folder:AddBind({ text = 'Autoplayer toggle', flag = 'autoPlayerToggle', key = Enum.KeyCode.M, callback = function()
            ...
            folder:AddSlider({ text = 'Release delay (ms)', flag = 'autoDelay', min = 0, max = 350, value = 0 })
        end
